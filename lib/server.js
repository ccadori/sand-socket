...
class Socket extends events {
  constructor(options = {}, packetDelimiter = "\n", eventDelimiter = "#e#") {
    super();
    ...
    const createServer = options && options.tls? tls.createServer : net.createServer;

    this.server = createServer(options? options.serverOptions : {}, this.onClientEnter);
  }
